...
export default function RecommendationForm({ recommendation, submission, isSubmitting }) {
    ...
    <>
      <form onSubmit={handleSubmit(submission)}>
        ...
        <Box className="formArea" sx={{ width: "100%", gridColumn: "span 4" }}>
          <MyDescriptionField
            className="formField"
            label={"Brief description about the lecturer (research areas, achievements, etc.)"}
            name="content"
            rows={4}
            disabled={isChecking}
            control={control}
